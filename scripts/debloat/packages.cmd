...
powershell "Get-AppxPackage -Allusers *Microsoft.Windows.devhome* | Remove-AppxPackage"
powershell "Get-AppxPackage -Allusers | Where-Object {$_.Name -Like '*OutlookForWindows*'} | Remove-AppxPackage"
...
:: Remove remote desktop connection app - Optional due to auto-restart after removing
