...
:: Windows Defender Firewall - Uncomment line below if you want to disable.
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\mpsdrv" /v Start /t REG_DWORD /d 3 /f
...
:: Disable Brave VPN services
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\services\BraveVpnService" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\services\BraveVpnWireguardService" /v Start /t REG_DWORD /d 4 /f
...
:: Break Fullscreen and Legacy Flip Presentation mode for some apps
:: REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\ahcache" /v Start /t REG_DWORD /d 4 /f 
...
:: Might affect installation of store / appx apps, keep at 3, but if you have applied all other scripts, and you keep enabled it wont make a difference. It wont work.
...
:: This might break .msi installers
...
:: Responsible for slow startup, if disabled.
...
:: It will be kept enabled, but if you had your router properly configured, dhcp + dns forwarding (this would only make it easier), you would not need to have this service enabled.
:: You would only need to set the default ip, gateway and dns manually on the ethernet ipv4 adapter and be done with it.
:: If you do not know where the adapter are, open View Network Connections or use the command ncpa.cpl
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\cloudidsvc" /v Start /t REG_DWORD /d 4 /f
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\amdgpio2" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\bfs" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\blbdrive" /v Start /t REG_DWORD /d 4 /f
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\clreg" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\discache" /v Start /t REG_DWORD /d 4 /f
...
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\IntelPMT" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\iorate" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\ksthunk" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\MSKSSRV" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\MsSecCore" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\MsSecFlt" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\MSTEE" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\npsvctrig" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\PRM" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\RDPCDD" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\RDPENCDD" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\RDPREFMP" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\secdrv" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SgrmAgent" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\spaceport" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\srv" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\srv2" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\tunnel" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\UEFI" /v Start /t REG_DWORD /d 4 /f
REG ADD "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\UnionFS" /v Start /t REG_DWORD /d 4 /f
