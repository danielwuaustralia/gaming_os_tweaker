<#
	...
	2- My code is automated from the start.
	3- It has a auto download for the utility if you only want to run the script standalone.
	4- It has a auto startup functionality so you do not need to execute the script yourself every windows startup.
	5- I bring clarity in my code from the first steps straight from the documentation, where the counter part takes shorts combined code as to have less line of code. Usually much harder to understand why with a straight read.
	6- I bring support to both XHCI and EHCI, while the counter part only seem to support XHCI.
	7- I provide information about every device and addresses as to provide you with accurate information about everything.
	8- I provide information if your devices have no interrupters available.
