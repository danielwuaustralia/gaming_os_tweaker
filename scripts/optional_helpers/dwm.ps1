...
$Executables = @(
	...
	[PsObject]@{Path = "$env:SystemRoot\System32\backgroundTaskHost.exe"; Rules = ''}
	[PsObject]@{Path = "$env:SystemRoot\System32\ctfmon.exe"; Rules = ''}
	[PsObject]@{Path = "$env:SystemRoot\SystemApps\Microsoft.Windows.Cortana_cw5n1h2txyewy\SearchUI.exe"; Rules = ''}
	[PsObject]@{Path = "$env:SystemRoot\SystemApps\Microsoft.Windows.Search_cw5n1h2txyewy\SearchApp.exe"; Rules = ''}
)
